  ...
  return (
    <footer className="relative bottom-0 w-full bg-[#080808] ">
     <div className="flex md:gap-4 gap-9 text-3xl text-center justify-center items-center md:border-b-0 md:border-t-0 border-b border-t py-3 border-white">
            <a href="https://www.instagram.com/yalitim_osmaniye_mehmet_kara/" target="_blank" rel="noopener noreferrer" className="inline-flex justify-center items-center w-14 h-14 bg-transparent border-2 border-white text-white rounded-full transition-all duration-300 hover:bg-white hover:text-white hover:scale-110" aria-label='insta'>
                <i className="bx bxl-instagram  text-transparent bg-clip-text bg-gradient-to-tr from-yellow-400 via-pink-500 to-purple-600 text-3xl"></i>
            </a>
            <a href="https://www.facebook.com/mehmet.kara.955910" target="_blank" aria-label='face' rel="noopener noreferrer" className="inline-flex justify-center items-center w-14 h-14 bg-transparent border-2 border-white text-white rounded-full transition-all duration-300 hover:bg-white hover:text-white hover:scale-110">
      ...
      <p className="text-center text-white text-sm md:text-base py-6">© 2025
        Designed by<span>
          <a
