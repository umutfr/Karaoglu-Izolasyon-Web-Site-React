...
const Footer = () => {
  ...
  return (
    <footer className="relative bottom-0 w-full bg-[#080808] ">
     <div className="flex md:gap-4 gap-9 text-3xl text-center justify-center items-center md:border-b-0 md:border-t-0 border-b border-t py-3 border-[#191970]">
            <a href="https://www.instagram.com/yalitim_osmaniye_mehmet_kara/" target="_blank" rel="noopener noreferrer" className="inline-flex justify-center items-center w-14 h-14 bg-transparent border-2 border-[#191970] text-[#191970] rounded-full transition-all duration-300 hover:bg-[#191970] hover:text-white hover:scale-110" aria-label='insta'>
      ...
      <ul className="mt-0 p-0 text-2xl leading-relaxed mb-0 text-center list-none  flex flex-wrap justify-center items-center gap-6 md:gap-10 py-6 border-t border-b border-[#191970] bg-black">
        {[
          ...
          <li key={item.id} className="inline-block px-6">
            <a
              ...
              className="text-white border-b-[3px] border-transparent transition-all duration-300 mx-6 hover:text-[#191970] hover:border-[#191970]"
            >
              {item.text}
            </a>
          </li>
      ...
      <p className="text-center text-white text-sm md:text-base py-6 border-t border-[#191970]">© 2025
        Designed by <span>
          <a
            href="https://umutfr.dev/" 
            target="_blank"
            rel="noopener noreferrer"
            className="text-white border-b-[3px] border-transparent transition-all duration-300 mx-3 hover:text-[#191970] "
